...
## Who writes the most? {.tabset}

The data contains the most plays by French authors. But does it mean that they write the most? Could this be just an artifact of the data and how it was created? Perhaps the team preparing French data was the largest and could process most plays. And most plays from the ancient Greece have not even survived until today. So asking which nation has the most theatrical plays is not a good question to ask of this dataset. However, we can rephrase the question to make it more appropriate: on average, which plays are the longest in terms of their text?
...
## Let's rank the data properly {.tabset}
